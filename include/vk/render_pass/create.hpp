...
namespace vk {
	...
	struct vk::create_t<vk::render_pass> {
		...
		operator () (Args&&... args) const {
			...
			if constexpr(types::are_contain_range_of_value_type<vk::subpass_dependency>::for_types<Args...>) {
			...
			if constexpr(types::are_contain_range_of_value_type<vk::attachment_description>::for_types<Args...>) {
