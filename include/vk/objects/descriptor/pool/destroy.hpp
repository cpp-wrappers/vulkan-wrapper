...
namespace vk {
	...
	struct vk::destroy_t<vk::descriptor_pool> {
		...
		void operator () (Args&&... args) const {
			...
			auto handle = elements::of_type<vk::handle<vk::descriptor_pool>>::ignore_const::ignore_reference::for_elements_of(args...);

			vkDestroyDescriptorPool(
				(VkDevice) vk::get_handle_value(device),
				(VkDescriptorPool) vk::get_handle_value(handle),
