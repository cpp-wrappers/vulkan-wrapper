...
namespace vk {
	...
	struct vk::create_t<vk::descriptor_pool> {
		...
		requires types::are_exclusively_satsify_predicates<
			...
			types::are_may_contain_one_type<vk::descriptor_pool_create_flags>,
			types::are_contain_one_type<vk::max_sets>,
		...
		operator () (Args&&... args) const {
			...
			if constexpr(types::are_contain_type<vk::descriptor_pool_create_flags>::for_types_of<decay<Args>...>) {
				ci.flags = elements::of_type<vk::descriptor_pool_create_flags>(args...);
			}
