...
namespace vk {
	...
	void update_descriptor_sets(Args&&... args) {
		...
		if constexpr(types::are_contain_range_of_value_type<vk::write_descriptor_set>::for_types<Args...>) {
		...
		if constexpr(types::are_contain_range_of_value_type<vk::copy_descriptor_set>::for_types<Args...>) {
	...
	requires types::are_exclusively_satsify_predicates<
		types::vk::are_contain_one_possibly_guarded_handle_of<vk::device>,
		types::are_contain_decayed_same_as<vk::write_descriptor_set>
	>::for_types<Args...>
	void update_descriptor_set(Args&&... args) {
		return vk::update_descriptor_sets(
			...
			array{
				elements::decayed_same_as<vk::write_descriptor_set>(args...)
			}
		);
	}
	...
	requires types::are_exclusively_satsify_predicates<
		types::vk::are_contain_one_possibly_guarded_handle_of<vk::device>,
		types::are_contain_decayed_same_as<vk::copy_descriptor_set>
	>::for_types<Args...>
	void update_descriptor_set(Args&&... args) {
		return vk::update_descriptor_sets(
			elements::vk::possibly_guarded_handle_of<vk::device>(args...),
			array{
				elements::decayed_same_as<vk::copy_descriptor_set>(args...)
			}
		);
	}
